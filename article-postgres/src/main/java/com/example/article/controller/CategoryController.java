...
public class CategoryController {
    ...
    public CategoryDto create(@RequestBody @Valid CategoryDto categoryDto) {
        Article category = categoryService.create(categoryBuilder(categoryDto));
    ...
    private Article categoryBuilder(CategoryDto categoryDto) {
        return modelMapper.map(categoryDto, Article.class);
    }

    private CategoryDto categoryDtoBuilder(Article category) {
